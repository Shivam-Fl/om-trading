      ...
      <div className="mx-auto w-full  p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 basis-1/2 flex flex-col justify-center items-start">
            ...
            <p className="max-w-sm">
              Om Trading Corporation provides innovative trading and supply
              chain solutions worldwide. We ensure quality, efficiency, and
              sustainability in every aspect of international trade.
            </p>
          </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between gap-y-4">
          <span className="text-sm flex md:gap-x-4 text-gray-500 sm:text-center dark:text-gray-400">
            © 2024{" "}
            <Link href="/">
              <p className="hover:underline">Om Trading™</p>
            </Link>
            . All Rights Reserved.
          </span>
