      ...
      <div className="mx-auto w-full  p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
            ...
            <Link href="#">
              <p className="flex items-center">
                <Image
                  ...
                  height={32}
                />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Om Trading</span>
              </p>
            </Link>
            <p className='max-w-sm'>
            Om Trading Corporation provides innovative trading and supply chain solutions worldwide. We ensure quality, efficiency, and sustainability in every aspect of international trade.
            </p>
          </div>
          <div className="basis-1/2 grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              <h2 className="mb-2 text-sm font-semibold text-gray-900 uppercase dark:text-white">Head office</h2>
              <p className='text-gray-500'>XYZ XYZ XYZ XYZ</p>

              <h2 className="mb-2 mt-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Business Hours</h2>
              <p className='text-gray-500'>XYZ XYZ XYZ XYZ</p>
              {/* <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
        ...
        <div className="sm:flex sm:items-center sm:justify-between gap-y-4">
          <span className="text-sm flex md:gap-x-4 text-gray-500 sm:text-center dark:text-gray-400">
            © 2024 <Link href="/"><p className="hover:underline">Om Trading™</p></Link>. All Rights Reserved.
          </span>
          <div className="text-sm flex text-gray-500 sm:text-center dark:text-gray-400">
            Made by <Link href="/"><p className="hover:underline">@CodersFortify Technologies™</p></Link>
          </div>
